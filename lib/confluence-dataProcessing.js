...
async function _processAttachmentsAcrossAllSpaces(
	...
	const allMediaTypes = Object.entries(ALLOWED_FILE_EXTENSION_TYPE_MAP);
...
async function _processAttachmentsInPages(functionName, cachedPageData) {
	const allAcceptedFileExtensions = Object.keys(
		ALLOWED_FILE_EXTENSION_TYPE_MAP
	);
	const allAcceptedMimeTypes = Object.values(ALLOWED_FILE_EXTENSION_TYPE_MAP);
